...
my_experiment
#need to write my_experiment again to show the number
```
...
#don't name values after functions cause they will not work and will be confusing to work with
```
...
The series of numbers in "new_vector" is unable to get a mean because it contains an NA.
