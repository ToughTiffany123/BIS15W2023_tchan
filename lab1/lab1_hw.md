...
RStudio is a GUI that allows working in R to be easier. R is the actual code. GitHub is a wedsite where coders tend to store their codes so it is accessible on any computer.
